...
function predictWebcam(){
    ...
    model.detect(video).then(function(predictions){
        ...
        ///loop through predictions and draw them to live if high confidence score///
        for (let n= 0; n < predictions.length; n++){
          ...
          if (predictions[n].score > 0.66) {
            ...
            p.style =
              "margin-left: " +
              predictions[n].bbox[0] + "px; margin-top: " +
        ...
        ///call function again to predict when the browser is ready
